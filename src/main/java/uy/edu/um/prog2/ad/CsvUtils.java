            ...
            for (CSVRecord csvRecord : csvParser) {
                ...
                try {
                    ...
                    if (userLinkedList.contains(user)) {
                        ...
                        if (date.isAfter(user.getLastTweet())) {
                            user.setLastTweet(date);
                            user.setIsVerified(Boolean.parseBoolean(csvRecord.get(8))); // Actualizar el estado verificado si se encuentra un tweet más reciente
                        }
                    } else {
